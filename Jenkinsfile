...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.62.191:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-ejikemec', //update and provide your channel name
